...
$(document).ready(function() {
    ...
    $("html,body").on("DOMMouseScroll mousewheel scroll touchmove", function(a) {
        ...
        if (c) {
            ...
            window.sidebarShown || window.popupShown || window.blockScroll || (window.smoothScroll ? (a.preventDefault(),
            g > 1500 && (g = 1500),
            g < -1e3 && (g = -1500),
            TweenLite.to(b, .5, {
                scrollTo: {
    ...
    $(document).on("keydown", function(a) {
        var b = 2.5
          ...
          , f = d.scrollTop()
          , g = f + parseInt(b * c);
        window.window.disableKeyNavigation || "input" == a.target.nodeName.toLowerCase() || "textarea" == a.target.nodeName.toLowerCase() || (37 === a.keyCode && (a.preventDefault(),
    ...
    $(x).length > 0 && $(x).each(function(a, b) {
        ...
        (c.hasClass("clickable") || c.hasClass("autoplay")) && c.on("click next", function(a) {
            ...
            window.sliderStatus && $html.removeClassByPrefix("slider_" + f).addClass("slider_" + f + "_" + e),
            h && (b.addClass("animateOnEvent"),
            ...
            $(window).scroll()),
            f && g.length > 0 && (g.children(".selected").removeClass("selected"),
    ...
    if (y.length > 0) {
        ...
        y.on("click", z, function() {
            ...
            a.hasClass("selected") || (c.removeClass("selected"),
            a.addClass("selected"),
            f.children(".selected").removeClass("selected").addClass("hide").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function() {
                $(this).removeClass("hide")
            }),
            f.children("li").eq(d).removeClass("hide").addClass("selected"),
            window.sliderStatus && $html.removeClassByPrefix("slider_" + sliderID).addClass("slider_" + sliderID + "_" + d)),
            g && (f.addClass("animateOnEvent"),
    ...
    $("[data-slider-action]").click(function() {
        if ($(this).data("slider-id")) {
            var a, b, c = $(this), d = c.data("slider-id"), e = c.data("slider-action"), f = $('.slider[data-slider-id="' + d + '"]'), g = $('.controller[data-slider-id="' + d + '"]'), h = g.data("controller-selector") ? g.data("controller-selector") : "li", i = f.find(".selected"), j = f.hasClass("animated");
            "next" === e ? a = i.nextOrFirst("li") : "prev" === e ? a = i.prevOrLast("li") : (parseInt(e) || 0 === e) && (b = parseInt(e),
            a = f.find(">li:eq(" + b + ")")),
            b = a.index(),
            i.removeClass("selected"),
            a.removeClass("hide").addClass("selected"),
            window.sliderStatus && $html.removeClassByPrefix("slider_" + d).addClass("slider_" + d + "_" + b),
            j && (f.addClass("animateOnEvent"),
            f.find("li").removeClassByPrefix("ae-").removeClass("do"),
            f.find(".selected").each(function(a) {
                $(this).removeClassByPrefix("ae-").removeClass("do").addClass("ae-" + (a + 1)).addClass("do")
            }),
            $(window).scroll()),
            d && g.length > 0 && (g.find(".selected").removeClass("selected").addClass("hide").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function() {
                c.removeClass("hide")
            }),
